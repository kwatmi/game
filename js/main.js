...
// create Players
let player1 = new Player('Monkey Player', 100, 'player1', 1, 'wp-1', 10, 'image/path-1.png');
let player2 = new Player('jaguar Player', 100, 'player2', 2, 'wp-1', 10, 'image/path-2.png');
